====================================================================
  VERDIGRIS -- BOSS GEM loot beam for ROSE Online
  teal
====================================================================

WHAT THIS IS
A replacement drop model for boss gems -- a large cut stone held in a
claw setting, with a beam of light above it.

Four gem types share one model in the game, each reading its own
texture, so this pack ships the texture into all four folders. That way
every boss gem gets the beam rather than just one of them.
...
NOTES
--------------------------------------------------------------------
* The four textures are identical. They are separate files because the
  game asks for one per folder.
